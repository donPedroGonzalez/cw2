...
{   
    ...
    firstPart = [ 'Uzupełnij', 'Je', "J'", "J'", 'Je', "J'", 'Je', 'Je', "J'", "J'", 'Je', "J'", "J'"];
    secondPart = [ 'Podpowiedź w nawiasie', "l'alcool.", 'la mer.', 'la viande.', 'chanter.', 'voyager.', 'la bière.', 'le vin.', 'la cuisine française.', 'le fromage.', 'le bruit.', 'les animaux.', 'les fleurs.'];
    missingElement = [ 'Les goûts', 'déteste', 'aime', 'adore', "n'aime pas", 'adore', 'déteste', "n'aime pas", 'aime', 'adore', 'déteste', 'adore', 'aime' ];
    hints = [ "", 'Nie znoszę alkoholu.', 'Lubię morze.', 'Uwielbiam mięso.', 'Nie lubię śpiewać.', 'Uwielbiam podróżować.', 'Nie znoszę piwa.', 'Nie lubię wina.', 'Lubię kuchnię francuską.', 'Uwielbiam ser.', 'Nie znoszę hałasu.', 'Uwielbiam zwierzęta.', 'Lubię kwiaty.'];
